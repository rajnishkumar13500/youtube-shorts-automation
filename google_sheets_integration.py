...
class GoogleSheetsReader:
    ...
    def read_video_topics(self, sheet_name: str = "Videos", range_name: str = "A2:D") -> List[Dict]:
        """
        Read video topics from Google Sheets.
    ...
    def update_status(self, row_number: int, status: str, video_url: str = "", sheet_name: str = "Videos"):
        """
